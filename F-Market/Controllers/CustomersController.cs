...
namespace F_Market.Controllers
{
    ...
    {
        private F_MarketContext db = new F_MarketContext();
        ...
        public ActionResult Create([Bind(Include = "CustomerId,Name,ContactFirstName,ContactLastName,Phone,Addreess,Email,Document,DocumentTypeId")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CustomerId,Name,ContactFirstName,ContactLastName,Phone,Addreess,Email,Document,DocumentTypeId")] Customer customer)
        {
            if (ModelState.IsValid)
            {
